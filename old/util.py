...
def split_rows(rows, regex=None, sep=None):
  ...
  [('1-2', '3'), ('4-5', '6')]
  >>> split_rows(['Alice would gain 54 happiness units by sitting next to Bob.'], regex='(\w+) would (gain|lose) (\d+) happiness units? by sitting next to (\w+).')
  [('1-2', '3'), ('4-5', '6')]
  """
  def g():
    for row in rows:
...
# TODO: need generalized pairwise
